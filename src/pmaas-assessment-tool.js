...
const PMaaSAssessmentTool = () => {
  ...
  const sendResultsByEmail = async () => {
    setIsSending(true)
    try {
      // Assuming pmaasData is available globally or passed as a prop
              ...
              <div key={question.id} className="mb-6">
                ...
                {question.type === "dropdown" ? (
                  <Select
                    ...
                    onChange={(value) => handleOptionSelect(question.id, Number(value))}
...
ReactDOM.createRoot(document.getElementById("pmaas-assessment-container")).render(<PMaaSAssessmentTool />)
